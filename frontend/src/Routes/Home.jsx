    ...
    <div className="bg-gray-300 min-h-screen">
      ...
      <nav className="bg-white p-4 rounded-t-lg flex justify-between items-center">
        ...
        <div className="flex space-x-4">
          <button className="rounded-lg bg-blue-700 text-white px-4 py-2">Televendas 0800 616 6161</button>
          <button className="rounded-lg bg-blue-700 text-white px-4 py-2">Inicie Sessão</button>
          <button className="rounded-lg bg-blue-700 text-white px-4 py-2">Viagens</button>
          <button className="rounded-lg bg-blue-700 text-white px-4 py-2">Ajuda</button>
        </div>
      </nav>
      ...
      <div className="h-64 bg-cover bg-center flex items-end">
        <div className="bg-black bg-opacity-50 text-white p-4 rounded-lg">
          ...
          <div className="flex space-x-2">
            ...
            <button className="rounded-lg bg-blue-700 text-white px-4 py-2">Pesquisar</button>
          </div>
        </div>
      </div>
      ...
      <section className="bg-white p-4 rounded-lg mt-4">
        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <button className="rounded-lg bg-blue-700 text-white px-4 py-2">Quero Recebê-las</button>
        </div>
