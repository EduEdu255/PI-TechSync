  ...
  return (
    loggedUser && (
      <>
        ...
        {loggedUser && loggedUser["@type"] != "GoogleUser" && (
          <input
            type="file"
            accept="image/*"
        ...
        <div
          ...
          className={`rounded-full h-[250px] aspect-square bg-[image:var(--image-url)] bg-center bg-cover bg-no-repeat hover:bg-[image:var(--image-url-hover)] cursor-pointer`}
          onClick={clickImage}
        ></div>
      </>
    )
